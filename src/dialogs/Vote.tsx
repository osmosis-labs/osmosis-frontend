...
import cn from 'clsx';
import { BaseDialogProps, FocusedBaseDialog } from './base';
import { IProposalState } from '../pages/governance/Governance';
...
export const VoteDialog: FunctionComponent<BaseDialogProps & { proposalIndex: number }> = ({
	isOpen,
	close,
	style,
	proposalIndex,
	...
	return (
		<FocusedBaseDialog isOpen={isOpen} close={close} style={style}>
