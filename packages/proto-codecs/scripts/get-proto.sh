...
OSMOSIS_COMMIT_HASH="249ab294d04bc36d7063dcf01fa0f613f0ce42f2"
...
git clone https://github.com/osmosis-labs/osmosis.git .repos/osmosis
...
git clone https://github.com/cosmos/cosmos-sdk.git .repos/cosmos-sdk

# Checkout to Cosmos hash commit
# git -C .repos/cosmos-sdk sparse-checkout set proto
# git -C .repos/cosmos-sdk set proto
git fetch --all --tags
...
git clone https://github.com/cosmos/ibc-go.git .repos/ibc-go
...
git clone https://github.com/osmosis-labs/wasmd.git .repos/wasmd
...
git clone https://github.com/cosmos/ics23.git .repos/ics23
