...
export const AppDescriptor = {
  ...
  fromAmino(object: AppDescriptorAmino): AppDescriptor {
    return {
      authn: object?.authn
        ? AuthnDescriptor.fromAmino(object.authn)
        : undefined,
      chain: object?.chain
        ? ChainDescriptor.fromAmino(object.chain)
        : undefined,
      codec: object?.codec
        ? CodecDescriptor.fromAmino(object.codec)
        : undefined,
      configuration: object?.configuration
        ? ConfigurationDescriptor.fromAmino(object.configuration)
        : undefined,
      queryServices: object?.query_services
        ? QueryServicesDescriptor.fromAmino(object.query_services)
        : undefined,
  ...
  fromAmino(object: TxDescriptorAmino): TxDescriptor {
    return {
      ...
      msgs: Array.isArray(object?.msgs)
        ? object.msgs.map((e: any) => MsgDescriptor.fromAmino(e))
        : [],
    };
  },
  ...
  fromAmino(object: AuthnDescriptorAmino): AuthnDescriptor {
    return {
      signModes: Array.isArray(object?.sign_modes)
        ? object.sign_modes.map((e: any) => SigningModeDescriptor.fromAmino(e))
        : [],
    };
  },
  ...
  fromAmino(object: CodecDescriptorAmino): CodecDescriptor {
    return {
      interfaces: Array.isArray(object?.interfaces)
        ? object.interfaces.map((e: any) => InterfaceDescriptor.fromAmino(e))
        : [],
    };
  },
  ...
  fromAmino(
    ...
    return {
      config: object?.config
        ? ConfigurationDescriptor.fromAmino(object.config)
        : undefined,
    };
  },
  toAmino(
  ...
  fromAmino(
    ...
    return {
      queries: object?.queries
        ? QueryServicesDescriptor.fromAmino(object.queries)
        : undefined,
    };
  },
  toAmino(
    ...
    return {
      queryServices: Array.isArray(object?.query_services)
        ? object.query_services.map((e: any) =>
            QueryServiceDescriptor.fromAmino(e)
          )
        : [],
    };
  },
  ...
  fromAmino(object: QueryServiceDescriptorAmino): QueryServiceDescriptor {
    return {
      ...
      methods: Array.isArray(object?.methods)
        ? object.methods.map((e: any) => QueryMethodDescriptor.fromAmino(e))
        : [],
    };
  },
