  ...
  fromAmino(
    ...
    return {
      rewards: object?.rewards
        ? ValidatorOutstandingRewards.fromAmino(object.rewards)
        : undefined,
    };
  },
  toAmino(
  ...
  fromAmino(
    ...
    return {
      rewards: Array.isArray(object?.rewards)
        ? object.rewards.map((e: any) => DecCoin.fromAmino(e))
        : [],
    };
  },
  toAmino(
  ...
  fromAmino(
    ...
    return {
      ...
      total: Array.isArray(object?.total)
        ? object.total.map((e: any) => DecCoin.fromAmino(e))
        : [],
    };
  },
  toAmino(
  ...
  fromAmino(
    ...
    return {
      pool: Array.isArray(object?.pool)
        ? object.pool.map((e: any) => DecCoin.fromAmino(e))
        : [],
    };
  },
  toAmino(
