...
export const StakeAuthorization = {
  ...
  fromAmino(object: StakeAuthorizationAmino): StakeAuthorization {
    return {
      maxTokens: object?.max_tokens
        ? Coin.fromAmino(object.max_tokens)
        : undefined,
      allowList: object?.allow_list
        ? StakeAuthorization_Validators.fromAmino(object.allow_list)
        : undefined,
      denyList: object?.deny_list
        ? StakeAuthorization_Validators.fromAmino(object.deny_list)
        : undefined,
