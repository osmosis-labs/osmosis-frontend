  ...
  fromAmino(object: ConnectionEndAmino): ConnectionEnd {
    return {
      ...
      versions: Array.isArray(object?.versions)
        ? object.versions.map((e: any) => Version.fromAmino(e))
        : [],
  ...
  fromAmino(object: CounterpartyAmino): Counterparty {
    return {
      ...
      prefix: object?.prefix
        ? MerklePrefix.fromAmino(object.prefix)
        : undefined,
    };
  },
...
export const Params = {
  ...
  fromAmino(object: ParamsAmino): Params {
    return {
      maxExpectedTimePerBlock: Long.fromString(
