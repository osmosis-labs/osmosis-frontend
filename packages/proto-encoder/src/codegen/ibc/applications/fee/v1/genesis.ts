    ...
    return {
      ...
      forwardRelayers: Array.isArray(object?.forward_relayers)
        ? object.forward_relayers.map((e: any) =>
            ForwardRelayerAddress.fromAmino(e)
          )
        : [],
    };
  },
...
export const RegisteredCounterpartyPayee = {
  ...
  fromAmino(
    object: RegisteredCounterpartyPayeeAmino
  ): RegisteredCounterpartyPayee {
    return {
      channelId: object.channel_id,
      relayer: object.relayer,
  ...
  toAmino(
    message: RegisteredCounterpartyPayee
  ): RegisteredCounterpartyPayeeAmino {
    const obj: any = {};
    obj.channel_id = message.channelId;
    obj.relayer = message.relayer;
  ...
  fromAminoMsg(
    object: RegisteredCounterpartyPayeeAminoMsg
  ): RegisteredCounterpartyPayee {
    return RegisteredCounterpartyPayee.fromAmino(object.value);
  },
  toAminoMsg(
    message: RegisteredCounterpartyPayee
  ): RegisteredCounterpartyPayeeAminoMsg {
    return {
      type: "cosmos-sdk/RegisteredCounterpartyPayee",
  ...
  fromProtoMsg(
    message: RegisteredCounterpartyPayeeProtoMsg
  ): RegisteredCounterpartyPayee {
  ...
  toProtoMsg(
    message: RegisteredCounterpartyPayee
  ): RegisteredCounterpartyPayeeProtoMsg {
    return {
      typeUrl: "/ibc.applications.fee.v1.RegisteredCounterpartyPayee",
