  ...
  fromAmino(object: ClientStateAmino): ClientState {
    return {
      ...
      trustLevel: object?.trust_level
        ? Fraction.fromAmino(object.trust_level)
        : undefined,
      trustingPeriod: object?.trusting_period
        ? Duration.fromAmino(object.trusting_period)
        : undefined,
      unbondingPeriod: object?.unbonding_period
        ? Duration.fromAmino(object.unbonding_period)
        : undefined,
      maxClockDrift: object?.max_clock_drift
        ? Duration.fromAmino(object.max_clock_drift)
        : undefined,
      frozenHeight: object?.frozen_height
        ? Height.fromAmino(object.frozen_height)
        : undefined,
      ...
      proofSpecs: Array.isArray(object?.proof_specs)
        ...
        : [],
      upgradePath: Array.isArray(object?.upgrade_path)
        ? object.upgrade_path.map((e: any) => e)
        : [],
...
export const Misbehaviour = {
  ...
  fromAmino(object: MisbehaviourAmino): Misbehaviour {
    return {
      ...
      header_1: object?.header_1
        ? Header.fromAmino(object.header_1)
        : undefined,
      header_2: object?.header_2
        ? Header.fromAmino(object.header_2)
        : undefined,
    };
  },
  toAmino(message: Misbehaviour): MisbehaviourAmino {
    ...
    obj.header_1 = message.header_1
      ? Header.toAmino(message.header_1)
      : undefined;
    obj.header_2 = message.header_2
      ? Header.toAmino(message.header_2)
      : undefined;
    return obj;
  },
  ...
  fromAmino(object: HeaderAmino): Header {
    return {
      ...
      validatorSet: object?.validator_set
        ...
        : undefined,
      trustedHeight: object?.trusted_height
        ? Height.fromAmino(object.trusted_height)
        : undefined,
