...
import { CfmmToClMigratonRecords } from "./types";

export class ObservableQueryCfmmConcentratedPoolLinks extends ObservableChainQuery<CfmmToClMigratonRecords> {
  ...
  readonly getLinkedConcentratedPoolId = computedFn(
    (cfmmPooLId): string | false | undefined => {
      ...
      return (
        this.response.data.migration_records.find(
