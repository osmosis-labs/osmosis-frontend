...
export const AvailableOneClickTradingMessagesSchema = z.enum([
...
export type AvailableOneClickTradingMessages = z.infer<
  typeof AvailableOneClickTradingMessagesSchema
>;
