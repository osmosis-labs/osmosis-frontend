// These methods stem from @keplr-wallet/cosmos and are moved here to avoid that dependency.
// TODO: Move to osmosis-labs/utils, for some reason Im getting local failures when I do that.
