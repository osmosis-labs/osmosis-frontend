...
export function isMsgSetWithdrawAddress(
  msg: Msg
): msg is MsgSetWithdrawAddress {
  // NOTE: Type string and names diverge here!
  return (
    (msg as MsgSetWithdrawAddress).type ===
...
export function isMsgWithdrawDelegatorReward(
  msg: Msg
): msg is MsgWithdrawDelegatorReward {
  // NOTE: Type string and names diverge here!
  return (
    (msg as MsgWithdrawDelegatorReward).type ===
...
export function isMsgWithdrawValidatorCommission(
  msg: Msg
): msg is MsgWithdrawValidatorCommission {
  return (
    (msg as MsgWithdrawValidatorCommission).type ===
...
export function isMsgFundCommunityPool(msg: Msg): msg is MsgFundCommunityPool {
  return (
    (msg as MsgFundCommunityPool).type === "cosmos-sdk/MsgFundCommunityPool"
  );
}
