...
/**
 * TendermintTxTracer is almost same with the `TendermintTxTracer` in the @osmosis-labs/keplr-cosmos library.
 * Changes for some mistake on the original `TendermintTxTracer`.
 */
