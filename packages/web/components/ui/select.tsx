...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <Icon className="h-4 w-4" id="chevron-up" width={16} height={16} />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <Icon className="h-4 w-4" id="chevron-down" width={16} height={16} />
  </SelectPrimitive.ScrollDownButton>
));
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Icon className="h-4 w-4" id="check-mark" width={16} height={16} />
      </SelectPrimitive.ItemIndicator>
    </span>
