        ...
        <div className="flex flex-[1_0_0] flex-col items-start gap-3 1.5xs:gap-y-6">
          <div className="flex items-center justify-between self-stretch 1.5xs:flex-col 1.5xs:gap-y-2">
            <div className="flex items-center gap-2">
              <p className="body2 subtitle1 leading-6 text-osmoverse-100">
                {user.name}
              </p>
              <Link
                ...
                passHref
                target="_blank"
                className="body2 text-sm font-medium leading-5 text-osmoverse-300 hover:underline"
            ...
            <time
              dateTime={createdAt}
              className="body2 font-medium leading-5 text-osmoverse-300"
            >
          ...
          <Link
            ...
            target="_blank"
            className="breakspaces body2 self-stretch font-medium leading-5 text-osmoverse-300"
            passHref
            onClick={onTweetLinkClick}
          >
            {text}
