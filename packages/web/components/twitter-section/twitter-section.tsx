...
function TwitterSection() {
  ...
  return (
    <div className="flex flex-1 flex-col items-start gap-6 self-stretch rounded-5xl border border-osmoverse-800 bg-osmoverse-900 py-10 px-8">
  ...
  return (
    <div className="flex flex-col items-start gap-4 self-stretch py-3">
      <div className="flex-start flex gap-4 self-stretch 1.5xs:flex-col">
        <div className="flex h-[52px] w-[52px] items-center gap-3 rounded-full bg-white-high 1.5xs:self-center" />
