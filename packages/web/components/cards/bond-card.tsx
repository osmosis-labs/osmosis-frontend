      ...
      >
        ...
        {userUnlockingShares && (
          <div className="flex w-fit flex-wrap items-center gap-1 rounded-lg bg-osmoverse-900 p-3 md:p-1.5">
            ...
            <span className="subtitle1 flex items-center gap-1 text-osmoverse-400">
...
> = (props) => {
  ...
  return (
    ...
    >
      <div className="button flex transform items-center gap-[10px] self-start px-[12px] py-1.5 text-wosmongton-200 duration-300 ease-inOutBack group-hover:-translate-x-[30px] group-hover:text-rust-300">
        <span
          ref={leftContentRef}
