  ...
  return (
    <>
      ...
      <div className="cursor-pointer" onClick={handleAppClicked}>
        <div className="app-display-card bg-white h-[320px] overflow-hidden rounded-2xl bg-osmoverse-800 shadow-md xl:h-[330px] lg:h-[320px] md:h-[360px] sm:h-[320px] xs:h-[330px]">
