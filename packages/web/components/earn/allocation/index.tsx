...
export const EarnAllocation = () => {
  return (
    <div className="relative flex min-w-[284px] flex-col gap-7">
      ...
      <small className="absolute -bottom-4 self-center text-[10px] font-subtitle2 font-medium text-osmoverse-300 opacity-50">
        scroll to see more
      </small>
    </div>
  );
