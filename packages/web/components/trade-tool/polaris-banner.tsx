  ...
  return (
    <div className="relative overflow-hidden flex flex-col my-3 gap-2 bg-[#653026] p-5 rounded-3xl">
      ...
      <h6 className="inline-flex items-center gap-1 text-[#FFFFFF70] font-semibold">
        ...
        <div className="px-1">
          <Image src="/logos/hype-logo.png" alt="HYPE" width={24} height={24} />
        </div>
      ...
      <Link
        ...
        target="_blank"
        className="py-3 px-4 bg-[#F99E53] rounded-3xl mt-6 flex items-center gap-1 text-[#0A0F0D] max-w-[260px] hover:bg-[#F78425] transition-colors"
      >
        <span className="subtitle1">Trade anything on Polaris</span>
