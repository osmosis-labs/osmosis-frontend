    ...
    >
      ...
      <div className="flex w-full items-center justify-between gap-2 pt-3 pb-2">
        {percentAdjustmentOptions.map(({ label, value, defaultValue }) => (
          <button
            type="button"
            className="flex h-8 w-full items-center justify-center rounded-5xl border border-[#6B62AD] px-3 py-1 text-wosmongton-200 transition hover:border-transparent hover:bg-osmoverse-700/[.54] hover:text-white-high disabled:opacity-50"
