...
const searchBoxClasses = cva(
  "flex flex-nowrap items-center justify-between gap-2 rounded-full bg-osmoverse-850 relative transition-colors [&_input]:placeholder:text-osmoverse-400 [&_input]:placeholder:font-medium",
  {
    variants: {
       ...
       */
      size: {
        small: "h-10 pl-5 pr-1 w-max [&_input]:body2",
        medium: "h-12 pl-5 pr-2 w-max [&_input]:body2",
        large: "h-14 pl-5 pr-3 w-max [&_input]:body1",
        long: "h-14 pl-5 pr-3 w-80 [&_input]:body1",
        full: "h-14 pl-5 pr-3 w-full [&_input]:body1",
      },
    },
    defaultVariants: {
      size: "small",
