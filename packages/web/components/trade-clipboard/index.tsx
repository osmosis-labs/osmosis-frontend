...
export const TradeClipboard: FunctionComponent<{
  ...
  const tokenInSelectCurrencies = useMemo(() => {
    return tokenSelectCurrencies.filter(
      (cur) =>
        cur.coinMinimalDenom !== tradeTokenInConfig.outCurrency.coinMinimalDenom
    );
  }, [tokenSelectCurrencies, tradeTokenInConfig.outCurrency.coinMinimalDenom]);
  ...
  }, [tokenSelectCurrencies, tradeTokenInConfig.sendCurrency.coinMinimalDenom]);
