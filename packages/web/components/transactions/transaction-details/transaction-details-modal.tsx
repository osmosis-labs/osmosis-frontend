...
> = ({ onRequestClose, isOpen, transaction }) => {
  ...
  return (
    <ModalBase
      ...
      className="max-w-[32.25rem] border border-osmoverse-700 !bg-osmoverse-1000 xl:!bg-osmoverse-850 sm:h-full sm:max-h-[100vh] sm:!rounded-none sm:py-0 sm:pt-2" // 516px
    >
