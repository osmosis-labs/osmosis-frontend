...
export const CosmosWalletRegistry: CosmosRegistryWallet[] = [
  ...
  {
    ...CosmosKitWalletList["okxwallet-cosmos-mobile"],
    logo: "/wallets/okx.png",
    lazyInstall: () =>
      import("~/integrations/okx-walletconnect").then(
        (m) => m.OkxMobileWallet
      ),
    supportsChain: async (chainId) => {
      const okxMobileAvailableChains: MainnetChainIds[] = [
        "cosmoshub-4",
        "osmosis-1",
        "secret-4",
        "regen-1",
      ...
      return okxMobileAvailableChains.includes(chainId as MainnetChainIds);
    },
    stakeUrl: "https://www.okx.com/web3/defi/staking/osmosis",
    governanceUrl: "https://www.okx.com/web3/defi/governance/osmosis",
    features: [],
  },
  {
