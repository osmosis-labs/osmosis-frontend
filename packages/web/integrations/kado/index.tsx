...
> = observer(({ assetKey }) => {
  ...
  return (
    <iframe
      src={`https://app.kado.money/?
      onPayCurrency=USD&onPayAmount=200&onRevCurrency=OSMO&offPayCurrency=${assetKey}&offRevCurrency=USD&network=OSMOSIS&onToAddress=${account?.address}&offFromAddress=X&cryptoList=OSMO,USDC,wBTC&networkList=OSMOSIS&apiKey=67a2aaad-a2a5-4412-be40-e3a70aa7b53d&product=BUY`}
      width="420"
      height="700"
