...
export const Staking: React.FC = () => {
  ...
  return (
    <main className="relative flex h-screen items-center justify-center">
      <div className="relative flex w-[27rem] flex-col gap-8 overflow-hidden rounded-[24px] bg-osmoverse-800 px-1 py-1 lg:mx-auto md:mt-mobile-header md:gap-6 md:px-3 md:pb-4 md:pt-4">
        <div className="relative flex flex-col gap-4 overflow-hidden rounded-[24px] bg-osmoverse-800 px-6 pb-8 pt-8 md:px-3 md:pb-4 md:pt-4">
