      ...
      <div className="flex place-content-between items-center">
        {onRequestBack && (
          <IconButton
            ...
            mode="unstyled"
            size="unstyled"
            className="!top-9.5 !md:left-7 !md:top-7 !absolute !left-8 !z-50 !w-fit !cursor-pointer !py-0 !text-osmoverse-400"
            icon={
        ...
        {!hideCloseButton && (
          <IconButton
            ...
            mode="unstyled"
            size="unstyled"
            className="!hover:text-white-full !md:right-7 !md:top-7 !xs:right-4 !absolute !right-8 !top-8 !z-50 !w-fit !cursor-pointer !py-0 !text-osmoverse-400"
