      ...
      <div className="flex w-full flex-col items-center gap-9">
        ...
        {(claimableRewardCoins?.length ?? 0) > 0 && (
          <div className="mt-8 flex w-full flex-col gap-3 py-3">
            <div className="subtitle1 pl-4 font-subtitle1 xl:pl-1">
  ...
  return (
    <button
      className={classNames(
        ...
        "xs:subtitle1 rounded-lg bg-osmoverse-700 px-5 py-2 text-h6 font-h6 text-wosmongton-100 hover:bg-osmoverse-600 xs:px-3",
        "whitespace-nowrap",
        {
...
export const AssetAmount: FunctionComponent<{
  ...
  <div
    className={classNames(
      "subtitle1 xs:body2 flex shrink-0 items-center gap-2 font-subtitle1",
      className
    )}
  >
