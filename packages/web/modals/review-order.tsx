            ...
            >
              ...
              {orderType === "limit" && tab !== "swap" && (
                <ErrorBoundary fallback={null}>
                  <LimitPriceHeader
                    tab={tab}
                    isBeyondOppositePrice={isBeyondOppositePrice}
                    baseDenom={baseDenom}
                    limitPriceFiat={limitPriceFiat}
                    percentAdjusted={percentAdjusted}
                    t={t}
                  />
                </ErrorBoundary>
              )}
                        ...
                        <div className="flex items-start gap-3 rounded-3x4pxlinset border-2 border-solid border-rust-500 p-5">
                          ...
                          <div className="flex flex-col gap-1">
                            ...
                            <span className="body2 sm:caption text-osmoverse-300">
                              {t(
                                "limitOrders.lowerSlippageToleranceRecommended"
                              )}
                            </span>
                          </div>
                        </div>
...
function LimitPriceHeader({
  ...
  try {
    priceLabel = limitPriceFiat
      ...
      : "";
    if (percentAdjusted) {
      percentLabel = formatPretty(percentAdjusted.mul(new Dec(100)).abs(), {
        maxDecimals: 3,
      });
    }
  } catch (error) {
    console.error("LimitPriceHeader format failed", error);
  }
  ...
  return (
    <div className="sm:caption flex flex-col rounded-t-2xl border border-osmoverse-700 px-4 py-2">
      <div className="flex items-center gap-4">
        ...
        {percentLabel != null && percentAdjusted && (
